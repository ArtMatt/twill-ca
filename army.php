...
<div class="game" id="army" style="background-image: url('https://castleagegame1-a.akamaihd.net/graphics/ws_middle.jpg'); width: 760px; padding: 0 0px;overflow-x:hidden;">
	<div id="globalcss" class="layout">
      		...
      		<div id="main_bntp" width="100%" >
				...
				<a href="http://web.castleagegame.com/castle/priv_policy.html" style="color:#b09060" > Privacy Policy </a> |
												<a href="army.php" onclick="ajaxLinkSend('globalContainer', 'army.php'); return false;" ><span style='color:#b09060;'>My Army (46)</span></a> |
								<a href="keep.php" onclick="ajaxLinkSend('globalContainer', 'keep.php'); return false;" ><span style='color:#b09060;'>My Stats (+1)</span></a>&nbsp;&nbsp;
				|
														Welcome Jew Pretender (<a onclick="javascript:document.location.href='connect_login.php?platform_action=CA_web3_logout';" href="#">Logout</a>)&nbsp;&nbsp;
									        		</div>
        		<div style="clear:both;"></div>
      		</div>
    	</div>
				...
				<div style="height:50px;overflow:hidden;">
					...
					<div style="float:left;width:150px;overflow:hidden;">
								...
								<div style="width:40px;height:40px;cursor:pointer;"
						    		 ...
						    		 <div style="width:740px;height:203px;background-image:url('https://castleagegame1-a.akamaihd.net/graphics/oracle_container_energy.jpg');background-repeat:no-repeat;">
										<div style='float:left; padding:21px 0 0 24px; width:190px;'>
											<img style="height:160px;" src="https://castleagegame1-a.akamaihd.net/graphics/hero_penelope.jpg" />
										</div>
										<div style='float:left;'>
											<div style="padding:0px; color:#591700; padding-top:30px;">
																							<div style='float:left;'>
													<a href="army.php?&quickbuychoice=6&option=2" onclick="ajaxLinkSend('globalContainer', 'army.php?&quickbuychoice=6&option=2'); return false;" ><div class="imgButton"><img src="https://castleagegame1-a.akamaihd.net/graphics/oracle_btn_recharge.gif" /></div></a>												</div>
											...
											<div style='padding:0px; color:#2d4200; padding-top:5px;'>
																									<div style='float:left;'>
														<a href="army.php?&refill=ene10" onclick="ajaxLinkSend('globalContainer', 'army.php?&refill=ene10'); return false;" ><div class="imgButton"><img src="https://castleagegame1-a.akamaihd.net/graphics/oracle_btn_potion.gif" /></div></a>													</div>
													<div style='float:left; font-size:11px; padding:8px 0 0 10px; font-weight:bold;'>
														2) Consume a 10 Energy Potion.
													</div>
																								<div style='clear:both;'></div>
											</div>
										</div>
						...
						<div style="float:left;width:90px;">
							...
							<div style='padding:2px 0 0 0;' title="37/37">
								<a href="oracle.php" onclick="ajaxLinkSend('globalContainer', 'oracle.php'); return false;"  style="text-decoration:none;color: #4b3715;font-size:11px;"><strong><span id="energy_current_value">37</span>/<span style=''>37</span></strong></a>							</div>
						</div>
						<div style="clear:both;"></div>
					...
					<div style="float:left;width:138px;overflow:hidden;">
									...
									onClick="PositionAndDisplayPopupAtTop('headerPersistStaminaRefill', this, '10', '200','noclass'); return false">
						    		 ...
						    		 <div style="width:740px;height:203px;background-image:url('https://castleagegame1-a.akamaihd.net/graphics/oracle_container_stamina.jpg');background-repeat:no-repeat;">
										...
										<div style='float:left;'>
											<div style="padding:0px; color:#591700; padding-top:30px;">
																							<div style='float:left;'>
													<a href="army.php?&quickbuychoice=6&option=1" onclick="ajaxLinkSend('globalContainer', 'army.php?&quickbuychoice=6&option=1'); return false;" ><div class="imgButton"><img src="https://castleagegame1-a.akamaihd.net/graphics/oracle_btn_recharge.gif" /></div></a>												</div>
												<div style='float:left; font-weight:bold; font-size:11px; padding-left:50px;'>
											...
											<div style='padding:0px; color:#2d4200; padding-top:5px;'>
																									<div style='float:left;'>
														<a href="generals.php" onclick="ajaxLinkSend('globalContainer', 'generals.php'); return false;" ><div class="imgButton"><img src="https://castleagegame1-a.akamaihd.net/graphics/oracle_btn_heroes.gif" /></div></a>													</div>
													<div style='float:left; font-size:11px; padding:8px 0 0 10px; font-weight:bold;'>
														2) Equip generals with stat altering abilities.
													</div>
																								<div style='clear:both;'></div>
											</div>
										</div>
						...
						<div style="float:left;width:89px;">
							...
							<div style='padding:2px 0 0 0;' title="37/37">
								<a href="keep.php" onclick="ajaxLinkSend('globalContainer', 'keep.php'); return false;"  style="text-decoration: none; color:#4b3715;font-size:11px;"><strong><span id="stamina_current_value">37</span>/<span style=''>37</span></strong></a>							</div>
						</div>
						<div style="clear:both;"></div>
					...
					<div style="float:left;width:138px;overflow:hidden;">
						    		 ...
						    		 <div style="width:740px;height:203px;background-image:url('https://castleagegame1-a.akamaihd.net/graphics/oracle_container_health.jpg');background-repeat:no-repeat;">
										...
										<div style='float:left;'>
											<div style="color:#591700;padding-top:30px;">
												<div style='float:left;'>
													<form onsubmit="ajaxFormSend('globalContainer', 'army.php?', this);return false;" method="post" id="headerHealForm" >
				                						<input type="hidden" value="heal_avatar" name="action" />
				                						<input type="hidden" name="bqh" value="0fc47f9d99ce68a3936d248e0856374c" />
						...
						<div style="float:left;width:89px;">
							...
							<div style='padding:2px 0 0 0;' title="100/100">
								<a href="keep.php" onclick="ajaxLinkSend('globalContainer', 'keep.php'); return false;"  style="text-decoration: none; color:#4b3715;font-size:11px;"><strong><span id="health_current_value">100</span>/<span style=''>100</span></strong></a>							</div>
						</div>
						<div style="clear:both;"></div>
					...
					<div style="float:left;width:140px;overflow:hidden;">
									...
									onClick="PositionAndDisplayPopupAtTop('headerPersistGoldRefill', this, '10', '200','noclass'); return false">
						    		 ...
						    		 <div style="width:740px;height:203px;background-image:url('https://castleagegame1-a.akamaihd.net/graphics/oracle_container_gold.jpg');background-repeat:no-repeat;">
										...
										<div style='float:left;'>
											<div style="color:#591700; padding-top:30px;">
												<div style='float:left;'>
													<form onsubmit="ajaxFormSend('globalContainer', 'army.php?', this);return false;" method="post">
												...
												<div style='float:left; font-weight:bold; font-size:11px; padding-left:50px;'>
													Spend a 10% fee to bank 3,000 gold.<br/>
						...
						<div style="float:left;width:88px;">
							...
							<div style='padding:2px 0 0 0;' title="$3,000">
								<a href="oracle.php" onclick="ajaxLinkSend('globalContainer', 'oracle.php'); return false;"  style="text-decoration: none; color: #4b3715;font-size:11px;"><strong id="gold_current_value" class="gold">$3,000</strong></a>							</div>
						</div>
						<div style='clear:both;'></div>

					</div>

					<div style="float:left;width:180px;overflow:hidden;" title="Your XP: 1772/1807&#013;You need 35 Experience Points to get to the next level.">
						<div style='padding:11px 0 0 17px;text-align:center;height:15px;overflow:hidden;'>
		                    <div style="overflow:hidden;width:154px;height:15px;background-color:black;">
		                    	<div style="background-image:url('https://castleagegame1-a.akamaihd.net/graphics/header_persist_xpbar.jpg');text-align:left;float:left;height:15px;width:84%;">&nbsp;</div>
		                    </div>

		                    <div style="position:relative;top:-15px;z-index:0;">
	                			<a href="keep.php" onclick="ajaxLinkSend('globalContainer', 'keep.php'); return false;"  style="text-decoration: none;font-size:10px;"><div style='color:#ffffff'>Level: 16</div></a>                			</div>
		                </div>
		                <div id="header_player_xp_totals" style='padding:2px 0 0 20px;display:none;filter:alpha(opacity=100);'>
		                	XP: <a href="quests.php" onclick="ajaxLinkSend('globalContainer', 'quests.php'); return false;"  style="text-decoration: none; color: #4b3715;font-size:11px;"><strong>1772/1807</strong></a>		                </div>
		                <div id="header_player_xp_needed" style='padding:2px 0 0 20px;filter:alpha(opacity=100);'>
		                	XP needed: <a href="quests.php" onclick="ajaxLinkSend('globalContainer', 'quests.php'); return false;"  style="text-decoration: none; color: #197B30;font-size:11px;"><strong>35</strong></a>		                </div>
					</div>
					...
					<div style="padding:4px 0 0 0;">
						...
						<div style="float:left;padding:0 0 0 5px;">
							<img src="https://castleagegame1-a.akamaihd.net/graphics/header_blue_left.jpg" 
								 ...
								 onClick="switchTabSection('main_header_tabs_view.php', 'mainHeaderTabs', '2_army.php?');"
								 />
						</div>
						...
						<div style="float:left;padding:0 0 0 10px;">
							<div style='width:163px;height:22px;background-image:url("https://castleagegame1-a.akamaihd.net/graphics/header_persist_collect_container.jpg");'>
								...
								<div style="float:left;width:70px;">
											...
											<form onsubmit="ajaxFormSend('globalContainer', 'army.php?', this);return false;" method="post">
												<input type="hidden" value="1" name="symbol">
												<input type="hidden" value="tributeHeader" name="action">
												<input type="image"  class="imgButton" src="https://castleagegame1-a.akamaihd.net/graphics/header_persist_btn_pray.gif" name="symbolsubmit" value="Receive Blessing" />
												<input type="hidden" name="ajax"  value="1" /> 
				            				</form>
				            			</div>
																		</div>
						...
						<div style="float:left;padding:0 0 0 10px;">
							<div style='width:163px;height:22px;background-image:url("https://castleagegame1-a.akamaihd.net/graphics/header_persist_collect_container_items.jpg");'>
								...
								<div style="float:left;width:70px;">
																		<div style="padding:3px 0 0 0;">
										<form onsubmit="ajaxFormSend('globalContainer', 'army.php?', this);return false;" method="post">
					        				<input type="hidden" name="action" value="enableItemArchiveBonusHeader" />
					        				<input class="imgButton" type="image" src="https://castleagegame1-a.akamaihd.net/graphics/header_persist_btn_eneable.gif" name="Enable Bonus!" />
					        				<input type="hidden" name="ajax"  value="1" />
					        			</form>
					        		</div>
																	</div>
						...
						<div style="float:left;padding:0 0 0 10px;">
							<div style='width:163px;height:22px;background-image:url("https://castleagegame1-a.akamaihd.net/graphics/header_persist_collect_container_wood.jpg");'>
								...
								<div style="float:left;width:70px;">
																		<div style="padding:3px 0 0 0;">
										<form onsubmit="ajaxFormSend('globalContainer', 'army.php?', this);return false;" method="post">
					        				<input type="hidden" name="action" value="conquestResourceCollectHeader" />
					        				<input class="imgButton" type="image" src="https://castleagegame1-a.akamaihd.net/graphics/header_persist_btn_collect.gif" />
					        				<input type="hidden" name="ajax"  value="1" />
					        			</form>
					        		</div>
					        										</div>
						...
						<div style="float:left;padding:0 0 0 10px;">
							<div style='width:163px;height:22px;background-image:url("https://castleagegame1-a.akamaihd.net/graphics/header_persist_collect_container_crystal.jpg");'>
								...
								<div style="float:left;width:70px;">
																		<div style="padding:3px 0 0 0;">
										<form onsubmit="ajaxFormSend('globalContainer', 'army.php?', this);return false;" method="post">
					        				<input type="hidden" name="action" value="conquestDemiCollectHeader" />
					        				<input class="imgButton" type="image" src="https://castleagegame1-a.akamaihd.net/graphics/header_persist_btn_pray.gif" />
					        				<input type="hidden" name="ajax"  value="1" />
					        			</form>
					        		</div>
					        										</div>
						...
						<div style="float:left;padding:0 0 0 10px;">
							<img src="https://castleagegame1-a.akamaihd.net/graphics/header_blue_right.jpg"
								 style="cursor:pointer"
								 onClick="switchTabSection('main_header_tabs_view.php', 'mainHeaderTabs', '4_army.php?');"
								 />
						</div>
			...
			<input type="hidden" id="gold_time_sec" value="-584997" />
		    <input type="hidden" id="gold_current_value_amount" value="3000" />
		    <input type="hidden" id="gold_current_recharge_time" value="3600" />
		    <input type="hidden" id="gold_current_increment" value="0" />
    	...
    	<div id="main_bn_container">
						...
						<div style='width:161px;height:4px;'></div>
	            	    														<div id="persistHomeFPPlateClosed" title="Favor Points" style='display:block;cursor:pointer;width:76px;height:35px;background-image:url("https://castleagegame1-a.akamaihd.net/graphics/home_fp_closed_plate.gif");'>
							...
							<div id="persistHomeFPPlateOpen" title="Favor Points" style='display:none;cursor:pointer;width:140px;height:35px;background-image:url("https://castleagegame1-a.akamaihd.net/graphics/home_fp_open_plate.gif");'>
								<div style="float:left;width:50px;height:100%;" onclick="ajaxLinkSend('globalContainer', 'oracle.php'); return false;">
								</div>
							...
							<div style='width:161px;height:4px;'></div>
															<div id="persistHomeConquestPlateClosed" title="Conquest Tokens" style='display:block;cursor:pointer;width:76px;height:35px;background-image:url("https://castleagegame1-a.akamaihd.net/graphics/home_conquest_closed_plate.gif");'>
								...
								<div id="persistHomeConquestPlateOpen" title="Conquest Tokens" style='display:none;cursor:pointer;width:140px;height:35px;background-image:url("https://castleagegame1-a.akamaihd.net/graphics/home_conquest_open_plate.gif");'>
									<div style="float:left;width:50px;height:100%;" onclick="ajaxLinkSend('globalContainer', 'guildv2_conquest_command.php'); return false;">
									</div>
									<div style="float:left;width:90px;height:100%;overflow:hidden;" 
	...
	<ul>
		...
		><a id='main_menu_town' href="soldiers.php" onclick="ajaxLinkSend('globalContainer', 'soldiers.php'); return false;" ></a>
						<ul id='mainMenu_town' style="display:none">
										...
										<li>
						<a href="territory.php" onclick="ajaxLinkSend('globalContainer', 'territory.php'); return false;" style='color:#00fafd'>
							Territory						</a>
					</li>
...
<div style="text-align:left;width:740px;">
		...
		<div style="width:740px;">
			<div style="clear:both"></div>			
							<div style="float:left;padding: 0 5px 0 0px">
					<a href="army.php" onclick="ajaxLinkSend('globalContainer', 'army.php'); return false;" ><img src="https://castleagegame1-a.akamaihd.net/graphics/invite_on.gif" /></a>				</div>
									<div style="float:left;padding: 0 5px 0 0px">
						<a href="gift.php" onclick="ajaxLinkSend('globalContainer', 'gift.php'); return false;" ><img class="imgButton" src="https://castleagegame1-a.akamaihd.net/graphics/tab_gifts_off.gif" /></a>					</div>
										<div style="float:left;padding: 0 5px 0 0px">
				<a href="army_member.php" onclick="ajaxLinkSend('globalContainer', 'army_member.php'); return false;" ><img class="imgButton" src="https://castleagegame1-a.akamaihd.net/graphics/view_army_off.gif" /></a>			</div>
			<div style="float:left;padding: 0 5px 0 0px">
				<a href="army_reqs.php" onclick="ajaxLinkSend('globalContainer', 'army_reqs.php'); return false;" ><img class="imgButton" src="https://castleagegame1-a.akamaihd.net/graphics/sent_invites_off.gif" /></a>			</div>
			<div style="clear:both"></div>
		</div>
		
		<div>
						<div style="width:740px; height:243px; background-image: url(https://castleagegame1-a.akamaihd.net/graphics/invite_page_progress_11.jpg);padding:7px 0 0 0;">
							<div style="clear:both"></div>
					<div style="float:right;text-align:right;width:150px;padding: 8px 25px 10px 0;color:#8dc63f;font-family:Verdana;font-size:14px;font-weight:bold;">
						Your Army Size: 46					</div>
				<div style="clear:both"></div>
			</div>
		</div>

				<div style="width:740px; height:41px; background-image: url(https://castleagegame1-a.akamaihd.net/graphics/invite_page_02.jpg);padding:7px 0 0 0;"></div>

		<div style="width:740px; background-image: url(https://castleagegame1-a.akamaihd.net/graphics/invite_page_03.jpg);padding:5px 0 0 0;">

			<div style="text-align:center;width:600px;padding: 10px 25px 10px 65px;color:#F0F8FF;font-family:Verdana; font-size:20px;font-weight:bold;">
			...
			<div style="text-align:center;width:600px;padding: 10px 25px 10px 65px;color:#F0F8FF;font-family:Verdana; font-size:20px;font-weight:bold;">
				Your army code: 7FB288			</div>
			
			<div style='text-align:center;padding-bottom:20px;'>
				
				<form onsubmit="ajaxFormSend('globalContainer', 'army.php', this);return false;" method="post">
					<div style='padding-bottom:10px;'>
						<input type="text" name='army_code'/>
					</div>
					<div class="imgButton">
						<input alt="Attack Monster" type="image" src="https://castleagegame1-a.akamaihd.net/graphics/request_pa_army.gif" name="Attack Dragon" />
					</div>
					<input type="hidden" name="action" value="invite_army_code" />
					<input type="hidden" name="ajax" value="1" />
				</form>
	...
	<div id="hot_swap_class_div" style="width:59px;height:190px;position:relative;z-index:1001;top:98px;left:4px;display:none;">
		<div style="background-image:url('https://castleagegame1-a.akamaihd.net/graphics/hot_classdropdown.gif');background-size:59px 190px;background-repeat:no-repeat;width:59px;height:190px;padding:70px 0px 0px 0px;text-align:center;">
					...
					<div style="width:100%;height:14px;overflow:hidden;color:white;font-size:6pt;">MAGE</div>
								...
								<div style="background-image:url('https://castleagegame1-a.akamaihd.net/graphics/hot_changeclassbtn.gif');width:51px;height:38px;margin:0px 0px 0px 2px;cursor:pointer;" onclick="doHotSwapClass('cleric');">
					<img src="https://castleagegame1-a.akamaihd.net/graphics/class_cleric.gif" style="width:20px;margin:3px 0px 0px 0px;" />
					<div style="width:100%;height:14px;overflow:hidden;color:white;font-size:6pt;">CLERIC</div>
				</div>
						</div>
	</div>
</div>
<div id="hot_swap_loadouts_div" style="width:94px;height:167px;position:relative;z-index:1001;left:445px;top:-633px;">
		...
		<div style="width:66px;height:120px;margin:0px 3px 0px 24px;overflow:hidden;">
				<div style="color:white;margin:40px 0px 0px 0px;font-size:8pt;">No loadouts available</div>
			</div>
		...
		<div style="width:66px;height:21px;margin:0px 0px 0px 24px;text-align:center;">
			<img id="hot_swap_loadout_scrollup" src="https://castleagegame1-a.akamaihd.net/graphics/hot_arrow_class_down.jpg" style="cursor:pointer;" onclick="scrollHotSwapLoadoutsDown(0, 0);" />
			<img id="hot_swap_loadout_scrolldown" src="https://castleagegame1-a.akamaihd.net/graphics/hot_arrow_class_up.jpg" style="cursor:pointer;" onclick="scrollHotSwapLoadoutsUp(0);" />
		</div>
	</div>
</div>
<div style='background-image:url("https://castleagegame1-a.akamaihd.net/graphics/hot_general_container.gif");width:178px;height:167px;float:right;font-weight:bold;z-index:1002;position:relative;left:-80px;top:-800px;'>
	...
	<div style="float:left;width:116px;">
		<div style='padding-left:4px;'>
			<a href="generals.php" onclick="ajaxLinkSend('globalContainer', 'generals.php'); return false;" ><div class="imgButton"><img title="click to select general" width="110" height="110" src="https://castleagegame1-a.akamaihd.net/graphics/hero_penelope.jpg" /></div></a>		</div>
	...
	<div style="float:left; width:60px;">
		<div onclick="ajaxLinkSend('globalContainer','item_equip.php');return false;" style='padding: 0 0 0 5px;cursor:pointer;'>
						...
						<img title="Sword of Light" alt="Sword of Light" src="https://castleagegame1-a.akamaihd.net/graphics/demi_attack_w0.jpg" style="width:24px;height:24px;"/>
					</div>
									<div style="float:left;width:26px;height:26px;overflow:hidden;padding:1px 1px 0px 0px;">
						<img title="Tempest Shield" alt="Tempest Shield" src="https://castleagegame1-a.akamaihd.net/graphics/demi_energy_shield.jpg" style="width:24px;height:24px;"/>
					</div>
									<div style="float:left;width:26px;height:26px;overflow:hidden;padding:1px 1px 0px 0px;">
						<img title="Poseidons Horn" alt="Poseidons Horn" src="https://castleagegame1-a.akamaihd.net/graphics/alchemy_weapon_horn_done.jpg" style="width:24px;height:24px;"/>
					</div>
									<div style="float:left;width:26px;height:26px;overflow:hidden;padding:1px 1px 0px 0px;">
						<img title="Dragon Charm" alt="Dragon Charm" src="https://castleagegame1-a.akamaihd.net/graphics/dragon_charm_spell.jpg" style="width:24px;height:24px;"/>
					</div>
									</div>
	</div>
	<div style="float:left;width:60px;height:28px;margin-top:2px;">
		<img src="https://castleagegame1-a.akamaihd.net/graphics/class_warrior.gif" style="float:left;width:24px;margin:2px 4px 0px 4px;" />
...
<input type='hidden' id='current_pg_url' value="army.php?"/>
<input type='hidden' id='current_pg_info' value="army.php?close_result=global_bottom"/>
